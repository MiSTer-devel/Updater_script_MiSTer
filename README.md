...
If you feel uncomfortable with a script which downloads and executes another script from the Internet, for security reasons, you can directly download and use [mister_updater.sh](https://github.com/MiSTer-devel/Updater_script_MiSTer/blob/master/mister_updater.sh?raw=true) and it will work the same, all .ini considerations will still be valid, but you will have to update the script manually.
